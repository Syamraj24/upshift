 ...
 */
?>
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|xlarge"}},"backgroundColor":"white","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-white-background-color has-background"><!-- wp:group {"align":"wide","style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80","right":"var:preset|spacing|20","left":"var:preset|spacing|20"}},"border":{"radius":"20px"}},"backgroundColor":"white-smoke","layout":{"type":"constrained","wideSize":"980px"}} -->
...
<figure class="wp-block-image size-full has-custom-border"><img src="<?php echo esc_url( get_theme_file_uri("assets/images/product.jpg") ); ?>" alt="" class="wp-image-378" style="border-radius:20px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<h2 class="wp-block-heading" style="letter-spacing:0.01em;line-height:1.3">Increase your sales and return on investment</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"600","lineHeight":"1.6"}},"fontSize":"xmeadium"} -->
<p class="has-xmeadium-font-size" style="font-style:normal;font-weight:600;line-height:1.6">Orci molestie nam vulputate nunc habitant gravida. Interdum vitae vivamus ipsum aliquet</p>
<!-- /wp:paragraph -->
...
<h3 class="wp-block-heading">180+</h3>
<!-- /wp:heading --></div>
<!-- /wp:column -->
...
<p class="has-small-font-size" style="line-height:1.7">Orci molestie nam vulputate nunc habitant gravida. Interdum vitae vivamus ipsum aliquet</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
