...
<main class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--80)">
    ...
    <h1 class="wp-block-heading alignwide has-text-align-center" style="font-style:normal;font-weight:800"><?php esc_html_e('Error 404', 'upshift'); ?></h1>
    <!-- /wp:heading -->
    ...
    <div class="wp-block-group alignwide">
        ...
        <p class="has-text-align-center aligncenter has-large-font-size" style="font-style:normal;font-weight:500"><?php esc_html_e("Unfortunately, this page doesn't exist.", 'upshift'); ?><br><?php esc_html_e('Try another search?', 'upshift'); ?></p>
        <!-- /wp:paragraph -->
