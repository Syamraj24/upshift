...
<main class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--80)">
    ...
    <h1 class="wp-block-heading alignwide has-text-align-center" style="font-style:normal;font-weight:800">Error 404</h1>
    <!-- /wp:heading -->
    ...
    <div class="wp-block-group alignwide">
        ...
        <p class="has-text-align-center aligncenter has-large-font-size" style="font-style:normal;font-weight:500">Unfortunately, this page doesn't exist.<br>Try another search?</p>
        <!-- /wp:paragraph -->
