...
<div class="wp-block-group alignfull has-text-color-background-color has-background" style="padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
    <!-- wp:heading {"textAlign":"center","style":{"spacing":{"padding":{"bottom":"var:preset|spacing|55"}}},"textColor":"bg-color"} -->
    <h2 class="wp-block-heading has-text-align-center has-bg-color-color has-text-color" style="padding-bottom:var(--wp--preset--spacing--55)"><?php esc_html_e('We are Up Shift &amp;', 'upshift'); ?><br><?php esc_html_e('Related articles', 'upshift'); ?></h2>
    <!-- /wp:heading -->
    ...
    <div class="wp-block-query alignwide">
        ...
        <div class="wp-block-group has-bg-color-background-color has-background" style="border-radius:20px">
            ...
            <div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--30);padding-right:25px;padding-bottom:43px;padding-left:25px">
                <!-- wp:post-terms {"term":"category","style":{"spacing":{"padding":{"right":"8px","bottom":"4px","left":"8px","top":"4px"}},"typography":{"fontStyle":"normal","fontWeight":"700"}},"backgroundColor":"primary","textColor":"dark","className":"category","fontSize":"xxx-small"} /-->
