...
<div class="wp-block-group alignfull has-background-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)"><!-- wp:group {"align":"wide","style":{"spacing":{"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"flex","flexWrap":"wrap","justifyContent":"center","orientation":"horizontal"}} -->
    <div class="wp-block-group alignwide" style="margin-top:0;margin-bottom:0"><!-- wp:paragraph {"style":{"layout":{"selfStretch":"fit"},"spacing":{"padding":{"top":"0","right":"6px","bottom":"0","left":"0"}},"typography":{"fontStyle":"normal","fontWeight":"700"}},"fontSize":"xmedium"} -->
        <p class="has-xmedium-font-size" style="padding-top:0;padding-right:6px;padding-bottom:0;padding-left:0;font-style:normal;font-weight:700"><?php esc_html_e('Trusted by these brands:', 'upshift'); ?></p>
        <!-- /wp:paragraph -->
        <!-- wp:image {"sizeSlug":"xlarge","linkDestination":"custom","className":"Upshift-Duotone-Primary"} -->
        <figure class="wp-block-image size-xlarge Upshift-Duotone-Primary"><img src="<?php echo esc_url($images[0]); ?>" alt=""/></figure>
        <!-- /wp:image -->

        <!-- wp:image {"sizeSlug":"xlarge","linkDestination":"custom","className":"Upshift-Duotone-Primary"} -->
        <figure class="wp-block-image size-xlarge Upshift-Duotone-Primary"><img src="<?php echo esc_url($images[1]); ?>" alt=""/></figure>
        <!-- /wp:image -->

        <!-- wp:image {"sizeSlug":"xlarge","linkDestination":"custom","className":"Upshift-Duotone-Primary"} -->
        <figure class="wp-block-image size-xlarge Upshift-Duotone-Primary"><img src="<?php echo esc_url($images[2]); ?>" alt=""/></figure>
        <!-- /wp:image -->

        <!-- wp:image {"sizeSlug":"xlarge","linkDestination":"custom","className":"Upshift-Duotone-Primary"} -->
        <figure class="wp-block-image size-xlarge Upshift-Duotone-Primary"><img src="<?php echo esc_url($images[3]); ?>" alt=""/></figure>
        <!-- /wp:image -->

        <!-- wp:image {"sizeSlug":"xlarge","linkDestination":"custom","className":"Upshift-Duotone-Primary"} -->
        <figure class="wp-block-image size-xlarge Upshift-Duotone-Primary"><img src="<?php echo esc_url($images[4]); ?>" alt=""/></figure>
        <!-- /wp:image -->
    </div>
    <!-- /wp:group -->
</div>
